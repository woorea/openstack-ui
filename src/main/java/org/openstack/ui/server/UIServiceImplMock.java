...
public class UIServiceImplMock extends RemoteServiceServlet implements UIService {
	...
	public ServerList listServers(int start, int max) {
		return new NovaServerList((Collection<NovaServer>) (Collection<?>) servers.values());
	}
	...
	public FlavorList listFlavors(int start, int max) {
		return new NovaFlavorList((Collection<NovaFlavor>) (Collection<?>) flavors.values());
	}
	...
	*/
	...
	public TenantList listTenants(int start, int max) {
		return new KeystoneTenantList((Collection<KeystoneTenant>) (Collection<?>) images.values());
	}
